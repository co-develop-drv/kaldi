...
if [ $stage -le 0 ]; then
  ...
  # apply-cmvn  --utt2spk=ark:/export1/kaldi-ali/kaldi-trunk/egs/aishell/s5/data/dev/split1/1/utt2spk scp:/export1/kaldi-ali/kaldi-trunk/egs/aishell/s5/data/dev/split1/1/cmvn.scp scp:/export1/kaldi-ali/kaldi-trunk/egs/aishell/s5/data/dev/split1/1/feats.scp ark:- | splice-feats  ark:- ark:- | transform-feats /export1/kaldi-ali/kaldi-trunk/egs/aishell/s5/exp/tri3a/final.mat ark:- ark:- | echo
    # transform-feats /export1/kaldi-ali/kaldi-trunk/egs/aishell/s5/exp/tri3a/final.mat ark:- ark:- 通过标准输入标准输出传递参数
    # splice-feats ark:- ark:- 
    # apply-cmvn --utt2spk=ark:/export1/kaldi-ali/kaldi-trunk/egs/aishell/s5/data/dev/split1/1/utt2spk scp:/export1/kaldi-ali/kaldi-trunk/egs/aishell/s5/data/dev/split1/1/cmvn.scp scp:/export1/kaldi-ali/kaldi-trunk/egs/aishell/s5/data/dev/split1/1/feats.scp ark:- 
